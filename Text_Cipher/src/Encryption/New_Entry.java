...
public class New_Entry extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			File FileObje = new File("/Users/isshu/Desktop/java_project/" + FName + "_" + LName + ".txt");
			...
			if(FileObje.createNewFile())
			{
				...
				try {
					...
					FileWriter WriterObje = new FileWriter("/Users/isshu/Desktop/java_project/" + FName + "_" + LName + ".txt");	
